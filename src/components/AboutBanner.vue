<template>
  <section class="service-banner">
    ...
    >
      ...
      >
        <div
          class="relative pt-[150px] w-full max-w-2xl max-[990px]:flex max-[990px]:flex-col max-[990px]:items-center max-[990px]:justify-center max-[990px]:pt-[50px]"
        >
          <h1
            class="mb-4 text-[50px] font-semibold leading-[1.2] text-tg-heading-font-color max-[990px]:text-center max-sm:text-4xl"
          >
            Welcome to Teamly: Where Digital Expertise Shapes Dreams
          </h1>
          <p class="mb-10 text-lg text-[#757589] max-[990px]:text-center">
            We are a team of dedicated professionals with a shared vision - to
            shape dreams into tangible digital experiences
          </p>
          <router-link
        ...
        <img
          ...
          src="@/assets/images/about-view/breadcrumb_img02.png"
          alt=""
        />
      </div>
