<template>
  <div class="relative pb-[135px] border-b border-gray-300">
    ...
    <div class="flex justify-between mt-5">
      <div class="flex flex-col w-[400px]">
        <label for="name" class="block mb-2 text-sm font-medium text-gray-900">Your telegram username</label>
        <input
          type="text"
          required
          @input="updateFirebaseName"
      ...
      <div class="flex flex-col w-[400px]">
        <label for="email" class="block mb-2 text-sm font-medium text-gray-900">Your phone number</label>
        <input
          type="text"
          required
          @input="updateFirebaseEmail"
