<template>
  <Suspense>
    ...
    >
      ...
      >
        <h1 class="mb-5 text-4xl text-center">Blog Modal</h1>
        <form
        ...
        >
          <div class="flex flex-col w-full">
            <div class="flex items-center justify-between w-full">
              <label class="text-gray-700" for="username">Sub title</label>
              <input
            ...
            <div class="flex items-center justify-between w-full mb-5">
              <label class="text-gray-700" for="blog-text">Text</label>
              <textarea
                class="w-[80%] min-h-[200px] max-h-[200px] p-2 mt-2 border border-gray-200 rounded-md outline-blue-300"
                id="blog-text"
                cols="10"
                rows="10"
              ></textarea>
