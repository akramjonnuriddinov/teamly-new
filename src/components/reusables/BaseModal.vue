<template>
  ...
  >
    <div
      @click.stop
      class="container rounded-xl overflow-y-hidden h-full bg-white relative mx-auto w-full max-xl:max-w-[990px] max-[800px]:max-w-2xl max-[990px]:max-w-3xl max-[680px]:max-w-xl pb-20"
      :class="width"
    >
      ...
      <div class="h-auto px-10 overflow-y-auto">
        <slot />
      </div>
    </div>
  </section>
