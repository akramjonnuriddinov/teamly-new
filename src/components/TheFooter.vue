    ...
    <div class="container w-full px-5 mx-auto max-w-7xl">
      <div class="teamly-container">
        ...
        <div class="flex flex-row flex-wrap text-center md:!text-start">
          ...
          <div class="basis-full md:!basis-4/12 xl:!basis-3/12 mb-6 md:pr-6 text-sm text-gray-300">
            <h4 class="mb-3 text-base font-medium text-gray-50">Get in Touch</h4>
            <div class="xl:!pr-28 mb-5">12 Ulitsa Khudzhant, Fergana, Uzbekistan</div>
          ...
          <div class="basis-full md:!basis-full xl:!basis-3/12 mb-6 text-base text-gray-50">
