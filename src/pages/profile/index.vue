<template>
  <section class="bg-[#F9F9FA] mt-[86px]">
    <div class="flex container px-5 mx-auto max-w-7xl max-xl:max-w-[990px] max-[800px]:max-w-2xl max-[990px]:max-w-3xl max-[680px]:max-w-xl">
      <Sidebar @selectItem="updateSelectedComponent" />
      <div class="main-content flex-grow relative top-10 py-4 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 mt-[85px] ps-[111px]">
