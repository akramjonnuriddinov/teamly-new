<template>
  <section class="mt-[86px] bg-[#F9F9FA]">
    ...
    >
      ...
      <div
        class="main-content relative left-0 top-10 z-40 mt-[85px] min-h-screen w-64 flex-grow py-4 ps-[111px] transition-transform max-[990px]:mt-0 max-[990px]:w-full max-[990px]:ps-4 max-[990px]:pt-0 sm:translate-x-0"
      >
