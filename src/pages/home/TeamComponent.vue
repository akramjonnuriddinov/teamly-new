<template>
  <section v-if="false" class="our-team bg-[#EFF7FF] bg-auto bg-no-repeat pb-[240px] pt-[135px]">
    <div class="container mx-auto w-full max-w-full px-5">
      ...
      <ul v-else class="flex flex-wrap justify-center gap-4 gap-y-20">
        ...
        >
          ...
          <div
            class="absolute bottom-0 left-1/2 flex w-full max-w-[90%] -translate-x-1/2 translate-y-1/2 flex-col items-center justify-center rounded-[20px] p-[30px] max-[700px]:max-w-[80%] max-[600px]:px-5 max-[400px]:max-w-[90%] max-[400px]:p-4"
          >
            <div class="absolute bottom-0 left-0 w-full text-center">
              <div class="dark:bg-dark-2 relative mx-5 overflow-hidden rounded-lg bg-white px-3 py-5">
                <h3 class="text-dark text-base font-semibold dark:text-white">
                  {{ team.title }}
                </h3>
                <p class="text-body-color dark:text-dark-6 text-xs">{{ team.position }}</p>
                <div>
  ...
  <!-- section 2 -->
  <section class="dark:bg-dark pb-10 pt-20 lg:pb-20 lg:pt-[120px]">
      ...
      <div class="-mx-4 flex flex-wrap justify-center">
        <template v-for="item in teams">
          <div class="w-full px-4 md:w-1/2 xl:w-1/4">
            <div class="team-content mx-auto mb-10 w-full max-w-[370px]">
