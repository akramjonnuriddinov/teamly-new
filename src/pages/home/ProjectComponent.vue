  ...
  <section class="bg-tg-white py-[105px]">
    <div class="container w-full px-5 mx-auto max-w-7xl">
      ...
      <ul v-else class="flex flex-wrap items-center justify-center gap-x-6 gap-y-10">
        ...
        >
          <div
            class="absolute z-10 flex items-center justify-center w-full h-full text-white rounded-md backdrop-blur-md"
          >
            Coming soon
          </div>
          ...
          >
            ...
            <router-link
              class="flex items-center justify-center p-3 transition-all duration-300 rounded-full opacity-0 project-wrapper-link bg-tg-white text-tg-primary-color hover:bg-tg-primary-color hover:text-tg-white"
              to="/"
            >
